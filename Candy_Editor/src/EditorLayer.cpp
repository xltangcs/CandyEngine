...
namespace Candy {
	...
	void EditorLayer::OnUpdate(Candy::Timestep ts)
	{
		// Resize
		if (Candy::FramebufferSpecification spec = m_Framebuffer->GetSpecification();
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				if (ImGui::MenuItem("Exit")) Candy::Application::Get().Close();
				ImGui::EndMenu();
			}
	...
	void EditorLayer::OnEvent(Candy::Event& e)
	{
