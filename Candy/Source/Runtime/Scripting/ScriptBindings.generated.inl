...
// Generated: 2026-08-19T20:56:47.922736
...
// StaticMeshComponent
py::class_<Candy::StaticMeshComponent>(m, "StaticMeshComponent")
    .def(py::init<>())
    .def_readwrite("MeshPath", &Candy::StaticMeshComponent::MeshPath)
    ;

// SkeletalMeshComponent
py::class_<Candy::SkeletalMeshComponent>(m, "SkeletalMeshComponent")
    .def(py::init<>())
    .def_readwrite("MeshPath", &Candy::SkeletalMeshComponent::MeshPath)
    .def_readwrite("ClipName", &Candy::SkeletalMeshComponent::ClipName)
    .def_readwrite("Speed", &Candy::SkeletalMeshComponent::Speed)
    .def_readwrite("Play", &Candy::SkeletalMeshComponent::Play)
    .def_readwrite("Loop", &Candy::SkeletalMeshComponent::Loop)
    ;

// CircleRendererComponent
py::class_<Candy::CircleRendererComponent>(m, "CircleRendererComponent")
    .def(py::init<>())
    .def_readwrite("Color", &Candy::CircleRendererComponent::Color)
    .def_readwrite("Thickness", &Candy::CircleRendererComponent::Thickness)
    .def_readwrite("Fade", &Candy::CircleRendererComponent::Fade)
    ;

// CameraComponent
py::class_<Candy::CameraComponent>(m, "CameraComponent")
    .def(py::init<>())
    ;

// LightComponent
py::class_<Candy::LightComponent>(m, "LightComponent")
    .def(py::init<>())
    .def_readwrite("Type", &Candy::LightComponent::Type)
    .def_readwrite("Color", &Candy::LightComponent::Color)
    .def_readwrite("Intensity", &Candy::LightComponent::Intensity)
    .def_readwrite("Range", &Candy::LightComponent::Range)
    .def_readwrite("InnerConeAngle", &Candy::LightComponent::InnerConeAngle)
    .def_readwrite("OuterConeAngle", &Candy::LightComponent::OuterConeAngle)
    .def_readwrite("CastShadows", &Candy::LightComponent::CastShadows)
    ;

// SkyboxComponent
py::class_<Candy::SkyboxComponent>(m, "SkyboxComponent")
    .def(py::init<>())
    .def_readwrite("CubemapPath", &Candy::SkyboxComponent::CubemapPath)
    .def_readwrite("Intensity", &Candy::SkyboxComponent::Intensity)
    .def_readwrite("Exposure", &Candy::SkyboxComponent::Exposure)
    ;

// NativeScriptComponent
py::class_<Candy::NativeScriptComponent>(m, "NativeScriptComponent")
    .def(py::init<>())
    ;
...
py::class_<Candy::BoxCollider2DComponent>(m, "BoxCollider2DComponent")
    ...
    .def_readwrite("RestitutionThreshold", &Candy::BoxCollider2DComponent::RestitutionThreshold)
    ;
...
py::class_<Candy::CircleCollider2DComponent>(m, "CircleCollider2DComponent")
    ...
    .def_readwrite("RestitutionThreshold", &Candy::CircleCollider2DComponent::RestitutionThreshold)
    ;
...
// LightType
py::enum_<Candy::LightComponent::LightType>(m, "LightType")
    .value("Directional", Candy::LightComponent::LightType::Directional)
    .value("Point", Candy::LightComponent::LightType::Point)
    .value("Spot", Candy::LightComponent::LightType::Spot)
    ;
