...
namespace Candy {
	...
	public:
		...
		/// Dump any stored D3D12 debug-layer messages (and the device-removed
		/// reason) to the log. Call after a GPU failure to see the real cause.
		void LogDebugLayerMessages() const;
