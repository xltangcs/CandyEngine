...
namespace Candy {
	...
	Candy::Ref<Candy::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Candy::Ref<Candy::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Candy::Ref<Candy::Shader> ShaderLibrary::Get(const std::string& name)
	{
