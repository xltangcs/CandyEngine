...
#define CANDY_INTERNAL_ASSERT_NO_MSG(type, check) CANDY_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", CANDY_STRINGIFY_MACRO(check), ::Candy::Assert::CurrentFileName(__FILE__), __LINE__)
